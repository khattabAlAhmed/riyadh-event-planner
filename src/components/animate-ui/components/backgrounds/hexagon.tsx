              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "before:content-[''] before:absolute before:top-0 before:start-0 before:w-full before:h-full before:bg-card before:opacity-100 before:transition-all before:duration-1000",
                    "after:content-[''] after:absolute after:inset-[var(--hexagon-margin)] after:bg-background",
                    'after:[clip-path:polygon(50%_0%,_100%_25%,_100%_75%,_50%_100%,_0%_75%,_0%_25%)]',
                    'hover:before:bg-muted hover:before:opacity-100 hover:before:duration-0 hover:after:bg-background hover:after:opacity-100 hover:after:duration-0',
